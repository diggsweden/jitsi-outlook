...
* Any imported libraries should also have licenses that are compatible with the MIT license. Avoid using libraries that have "bad" licenses, such as those that are restrictive, viral, or incompatible with other licenses.
